...
const Waitlist = () => {
  ...
  const rewards = [
    {
      icon: <CardGiftcard sx={{ fontSize: 40, color: '#f093fb' }} />,
      title: '10% Discount Voucher',
      description: 'Exclusive discount on your first experience',
      color: '#f093fb'
    },
    {
      icon: <WorkspacePremium sx={{ fontSize: 40, color: '#667eea' }} />,
      title: 'Priority Access',
      description: 'Early booking access to premium experiences',
      color: '#667eea'
    },
    {
      icon: <EmojiEvents sx={{ fontSize: 40, color: '#ffd700' }} />,
      title: '5000 Welcome XP',
      description: 'Redeemable points for future bookings',
      color: '#ffd700'
    },
    {
      icon: <Star sx={{ fontSize: 40, color: '#4ade80' }} />,
      title: 'VIP Member Events',
      description: 'Exclusive invites to special events',
      color: '#4ade80'
    }
  ];
                    ...
                    <Grid item xs={12} sm={6} md={3} key={index}>
                      ...
                      >
                        <Card sx={{
                          ...
                          boxShadow: `0 10px 30px ${reward.color}20`,
                          position: 'relative',
                          overflow: 'hidden',
                          display: 'flex',
                          ...
                          <Box sx={{
                            ...
                            right: 0,
                            height: 4,
                            background: `linear-gradient(90deg, ${reward.color} 0%, ${reward.color}80 100%)`
                          }} />
